...
//if($user == '' || $_SESSION['username'] =='admin'|| $_SESSION['username'] =='student' || $_SESSION['log_type'] =='admin' || $_SESSION['log_type'] =='student')
	if($user == '' || $_SESSION['log_type'] =='admin' || $_SESSION['log_type'] =='student')
		//if($user == '')
{
